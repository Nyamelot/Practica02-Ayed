...
// FASE I: operadores
rational_t operator+(const rational_t& rational1, const rational_t& rational2)
{
  return rational_t (( rational1.get_num() * rational2.get_den()) + (rational1.get_den() * rational2.get_num()), rational1.get_den() * rational2.get_den());
}
...
rational_t operator*(const rational_t& rational1, const rational_t& rational2)
{
  return rational_t (rational1.get_num() * rational2.get_num(), rational1.get_den() * rational2.get_den());
}
...
rational_t operator/(const rational_t& rational1, const rational_t& rational2)
{
  return rational_t (rational1.get_num() * rational2.get_den(), rational1.get_den() * rational2.get_num());
}
